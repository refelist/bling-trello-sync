...
class SincronizadorFake:
    ...
    def sincronizar_pedido(self, pedido_id: int, acao: str = "updated"):
        self.chamadas.append((pedido_id, acao))
        return type("R", (), {"__dict__": {}})()
...
def test_webhook_sincroniza_pedido(cliente, settings):
    ...
    assert sincronizador.chamadas == [(12345678, "created")]
